%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Function to calculate Frational rate, Dewell time, and Number of Transitions 
%%%% Written by Yiheng Tu and Zening Fu
%%%% Date: 7/8/2020
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [F, TM, MDT, NT] = statevector_stats(a, k)
% a is the input T*1 state vector from clusterInfo.states (each subject)
% k is the number of state
